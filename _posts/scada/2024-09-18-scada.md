...
img_path: /images/shodan/room_image.webp
---
...
| --------------------------------------------- | ----------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| city                                          | Name of the city                                                              | [Devices in San Diego](https://www.shodan.io/search?query=city%3A%22San+Diego%22)                        |
...
| port                                          | Port number for the service that is running                                   | [SSH servers](https://www.shodan.io/search?query=port%3A22)                                              |
...
| <font color="#de7802">hostname</font>         | <font color="#de7802">lookup a real IP websites , CVE of Organizations</font> | hostname:ammanu.edu.jo                                                                                   |
___
#### _General_
